...
function controlbol() {
  ...
  if (posboly >= 100 - heightbol / 2) {
    ...
    replacelifes();
    if (lifes == 0) {
      document.querySelector(".ps p:nth-child(1)").textContent =
        "Sorry ! You lose.";
  ...
  if (document.querySelector(".play").getAttribute("data-level") >= 1) {
    ...
    if (
      posboly >= 30 &&
      posboly <= 33 &&
      posbolx + widthbol / 2 >= poslevelbars1 &&
      posbolx + widthbol / 2 <= poslevelbars1 + 1
    ) {
      if (dirbolx == 0) {
        dirbolx = -1;
      } else {
      ...
      posboly >= 30 &&
      posboly <= 33 &&
      posbolx - widthbol / 2 <= poslevelbars1 + 15 &&
      posbolx - widthbol / 2 >= poslevelbars1 + 14
    ) {
      if (dirbolx == 0) {
        dirbolx = 1;
      } else {
  ...
  if (document.querySelector(".play").getAttribute("data-level") >= 2) {
    ...
    if (
      posboly >= 20 &&
      posboly <= 23 &&
      posbolx + widthbol / 2 >= poslevelbars2 &&
      posbolx + widthbol / 2 <= poslevelbars2 + 1
    ) {
      if (dirbolx == 0) {
        dirbolx = -1;
      } else {
      ...
      posboly >= 20 &&
      posboly <= 23 &&
      posbolx - widthbol / 2 <= poslevelbars2 + 15 &&
      posbolx - widthbol / 2 >= poslevelbars2 + 14
    ) {
      if (dirbolx == 0) {
        dirbolx = 1;
      } else {
  ...
  if (document.querySelector(".play").getAttribute("data-level") >= 3) {
    ...
    for (var i = 0; i < defeatblocks1; i++) {
      if (
        posboly + heightbol >= 48 &&
        posboly <= 50 &&
        posbolx + widthbol / 2 >=
          parseInt(divs[i].style.left.replace("%", "")) &&
        posbolx - widthbol / 2 <=
          parseInt(divs[i].style.left.replace("%", "")) + 10
      ) {
        dirboly *= -1;
  ...
  if (posboly + heightbol >= 50) {
    ...
    for (var i = 0; i < blocks; i++) {
      if (
        posboly + heightbol >=
          100 - parseInt(divs[i].style.top.replace("%", "") / 2 + 5) &&
        posboly <= 100 - parseInt(divs[i].style.top.replace("%", "") / 2)
      ) {
        if (
          Math.floor(posbolx - widthbol / 2) ==
          parseInt(divs[i].style.left.replace("%", "")) + 10
        ) {
  ...
  // bar colisions
  if (
    posbolx + widthbol / 2 >= posbarx - barWidth / 2 &&
    posboly <= 3 &&
    posbolx - widthbol / 2 <= posbarx + barWidth / 2
  ) {
    dirboly *= -1;
...
function start() {
  if (document.querySelector(".play").getAttribute("data-level") == 0) {
    document.getElementById("bar1").style.display = "none";
    document.getElementById("bar2").style.display = "none";
    document.getElementById("defeatblocks1").style.display = "none";
    document.getElementById("defeatblocks2").style.display = "none";
  }else if (document.querySelector(".play").getAttribute("data-level") == 1) {
    document.getElementById("bar1").style.display = "block";
    document.getElementById("bar2").style.display = "none";
    document.getElementById("defeatblocks1").style.display = "none";
    document.getElementById("defeatblocks2").style.display = "none";
  }else if (document.querySelector(".play").getAttribute("data-level") == 2) {
    document.getElementById("bar1").style.display = "block";
    document.getElementById("bar2").style.display = "block";
    document.getElementById("defeatblocks1").style.display = "none";
    document.getElementById("defeatblocks2").style.display = "none";
  }else if (document.querySelector(".play").getAttribute("data-level") == 3) {
    document.getElementById("bar1").style.display = "block";
    document.getElementById("bar2").style.display = "block";
    document.getElementById("defeatblocks1").style.display = "block";
    document.getElementById("defeatblocks2").style.display = "none";
  }else if (document.querySelector(".play").getAttribute("data-level") == 4) {
    document.getElementById("bar1").style.display = "block";
    document.getElementById("bar2").style.display = "block";
    document.getElementById("defeatblocks1").style.display = "block";
    document.getElementById("defeatblocks2").style.display = "block";
  }
  document.querySelectorAll("#blocks div").forEach((item) => {
    document.querySelector("#blocks").removeChild(item);
  });
  document.querySelectorAll(".hearts .fa-heart")
